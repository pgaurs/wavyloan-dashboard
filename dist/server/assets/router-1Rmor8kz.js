...
const appCss = "/assets/styles-D4ra2HE4.css";
...
const Route$1 = createRootRouteWithContext()({
  head: () => ({
    meta: [
      ...
      { title: "Wavyloan — AI Mortgage Processing" },
      { name: "description", content: "AI-powered mortgage loan processing dashboard. Deloitte OpenAI Technology Practice demo." },
      { property: "og:title", content: "Wavyloan — AI Mortgage Processing" },
      { property: "og:description", content: "AI-powered mortgage loan processing dashboard." },
...
const $$splitComponentImporter = () => import("./index-DxQQd201.js");
